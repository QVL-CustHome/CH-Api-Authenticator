...
/// Rôle renvoyé pour un super-admin, quel que soit le portail.
...
pub async fn validate(
    ...
    // Résolution du rôle : super-admin partout, sinon le rôle du portail visé.
    let role = if claims.super_admin {
